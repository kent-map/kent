...
![“The GoodwiImage(s) with location Sands” image from copyright status See Heroes of the Goodwin Sands by Thomas Stanley Treanor, 1904.](images/The Goodwin Sands img-019.jpg){: .right .dropshadow}
...
### References: 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyODMzMDc0NV19
-->